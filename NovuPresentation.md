...
| Campaign|  YES|   NO| ResponsePercentage|
|--------:|----:|----:|------------------:|
|        1|  646| 2411|               21.1|
|        2| 1090| 2558|               29.9|
...
| State| Campaign| YES|   NO| ConversionRate| PercentageChange|
|-----:|--------:|---:|----:|--------------:|----------------:|
...
|State | Campaign| T.Female| F.Con.Rate| T.Male| M.Con.Rate|
|:-----|--------:|--------:|----------:|------:|----------:|
...
|State | Campaign|Means |Difference |
|:-----|--------:|:-----|:----------|
|MN    |        1|73.6  |-          |
|MN    |        2|79.1  |5.5        |
|ND    |        1|73.1  |-          |
